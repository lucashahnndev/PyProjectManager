...
Uma ferramenta de linha de comando (CLI) poderosa e leve para centralizar, automatizar e simplificar o gerenciamento de projetos Python no ambiente Windows.
...
A instalação é simples e consiste em duas etapas: obter os arquivos e adicionar a pasta da ferramenta ao PATH do Windows.

#### Etapa 1: Obter os Arquivos

Você pode obter os arquivos usando Git ou fazendo o download manual.

**Opção A: Git Clone (Recomendado)**

```bash
git clone [https://github.com/seu-usuario/python-project-manager.git](https://github.com/seu-usuario/python-project-manager.git)
```
